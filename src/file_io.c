...
// Vulnerability ID 6-3: (Failure to Handle Errors Correctly) – checks fopen result and perror on fopen failure
// Vulnerability ID 6-3: (Failure to Handle Errors Correctly) – checks fprintf return value, prints to stderr and aborts early on error
...
// Vulnerability ID 6-4: (Failure to Handle Errors Correctly) – checks realloc return and perror on failure
